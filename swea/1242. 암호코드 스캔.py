...
for tc in range(1, TC+1):
    ...
    decode = {0: [2, 1, 1], 1: [2, 2, 1], 2: [1, 2, 2], 3: [4, 1, 1], 4: [
        1, 3, 2], 5: [2, 3, 1], 6: [1, 1, 4], 7: [3, 1, 2], 8: [2, 1, 3], 9: [1, 1, 2]}
    ...
    def validation(decodes):
        validation_sum = (decodes[0]+decodes[2]+decodes[4]+decodes[6]) * \
            3 + decodes[1] + decodes[3] + decodes[5] + decodes[7]
        sum = (decodes[0]+decodes[2]+decodes[4]+decodes[6]) + \
            decodes[1] + decodes[3] + decodes[5] + decodes[7]
